...
CollegeTools.Schema = (function() {
  ...
  var SHEETS = {
    ...
    SCHOLARSHIP_TRACKER: {
      ...
      userColumns: {},
      formulaColumns: {},
      systemColumns: setFromKeys(['SCHOLARSHIP_ID']),
      linkedColumns: {},
    },
    TASK_SETTINGS: {
      sheetName: CollegeTools.Config.SHEET_NAMES.TASK_SETTINGS,
      headerRow: 1,
      dataStartRow: 2,
      headers: CollegeTools.Config.HEADERS.TASK_SETTINGS,
      columns: keyMap(CollegeTools.Config.HEADERS.TASK_SETTINGS, [
        ['SETTING', 'Setting'],
        ['VALUE', 'Value'],
        ['GUIDANCE', 'Guidance'],
      ]),
      apiColumns: {},
      userColumns: setFromKeys(['VALUE']),
      formulaColumns: {},
      systemColumns: setFromKeys(['SETTING', 'GUIDANCE']),
      linkedColumns: {},
    },
    TASKS: {
      sheetName: CollegeTools.Config.SHEET_NAMES.TASKS,
      headerRow: 1,
      dataStartRow: 2,
      headers: CollegeTools.Config.HEADERS.TASKS,
      columns: keyMap(CollegeTools.Config.HEADERS.TASKS, [
        ['TASK_ID', 'Task ID'],
        ...
        ['OFFSET_WINDOW', 'Offset / Window'],
        ['OWNER', 'Owner'],
        ['OWNER_ROLE', 'Owner Role'],
        ['OWNER_LOCKED', 'Owner Locked'],
        ['DUE_DATE', 'Due Date'],
        ['EFFECTIVE_DATE', 'Effective Date'],
        ['DATE_LOCKED', 'Date Locked'],
        ['PLANNED_WEEK', 'Planned Week'],
        ['SCHEDULED_BLOCK', 'Scheduled Block'],
        ['PRIORITY', 'Priority'],
        ['PRIORITY_OVERRIDE', 'Priority Override'],
        ['STATUS', 'Status'],
        ['ADJUSTED_EFFORT', 'Adjusted Effort (min)'],
        ['EFFORT_OVERRIDE', 'Effort Override (min)'],
      ...
      apiColumns: {},
      userColumns: setFromKeys([
        'OWNER', 'OWNER_LOCKED', 'DUE_DATE', 'DATE_LOCKED', 'PLANNED_WEEK',
        'SCHEDULED_BLOCK', 'PRIORITY_OVERRIDE', 'STATUS', 'EFFORT_OVERRIDE', 'NOTES',
        'MANUALLY_SELECTED',
      ]),
      formulaColumns: {},
      systemColumns: setFromKeys([
        'TASK_ID', 'TEMPLATE_ID', 'COLLEGE_ID', 'APPLICABILITY_RULE',
        'SCHEDULE_RULE', 'SCHEDULE_ANCHOR', 'ANCHOR_DATE', 'OFFSET_WINDOW', 'OWNER_ROLE',
        'EFFECTIVE_DATE', 'PRIORITY', 'ADJUSTED_EFFORT', 'EVIDENCE_SOURCE',
        'COMPLETION_DATE', 'GENERATED', 'ARCHIVED_REASON',
      ]),
      linkedColumns: setFromKeys(['COLLEGE', 'COLLEGE_ID']),
    },
    TASK_TEMPLATES: {
      sheetName: CollegeTools.Config.SHEET_NAMES.TASK_TEMPLATES,
      headerRow: 1,
      dataStartRow: 2,
      headers: CollegeTools.Config.HEADERS.TASK_TEMPLATES,
      columns: keyMap(CollegeTools.Config.HEADERS.TASK_TEMPLATES, [
        ['TEMPLATE_ID', 'Template ID'],
        ['TASK', 'Task'],
        ['OWNER_ROLE', 'Owner Role'],
        ['EFFORT', 'Effort (min)'],
      ...
      userColumns: {},
      formulaColumns: {},
      systemColumns: setFromKeys(['TEMPLATE_ID', 'TASK', 'OWNER_ROLE', 'EFFORT']),
      linkedColumns: {},
    },
    THIS_WEEK: {
      sheetName: CollegeTools.Config.SHEET_NAMES.THIS_WEEK,
      headerRow: 1,
      dataStartRow: 2,
      headers: CollegeTools.Config.HEADERS.THIS_WEEK,
      columns: keyMap(CollegeTools.Config.HEADERS.THIS_WEEK, [
        ['TASK_ID', 'Task ID'],
        ['DUE_DATE', 'Due Date'],
        ['PRIORITY', 'Priority'],
        ['STATUS', 'Status'],
      ...
      formulaColumns: {},
      systemColumns: setFromKeys([
        'TASK_ID', 'DUE_DATE', 'PRIORITY', 'STATUS', 'OWNER', 'COLLEGE',
        'TASK', 'ADJUSTED_EFFORT', 'DECISION_NEEDED', 'SCHEDULE_FLAG',
      ]),
      linkedColumns: setFromKeys(['COLLEGE']),
    },
    RECRUITING_TRACKER: {
      sheetName: CollegeTools.Config.SHEET_NAMES.RECRUITING_TRACKER,
      headerRow: 1,
      dataStartRow: 2,
      headers: CollegeTools.Config.HEADERS.RECRUITING_TRACKER,
      optional: true,
      columns: keyMap(CollegeTools.Config.HEADERS.RECRUITING_TRACKER, [
        ['CONTACT_ID', 'Recruiting Contact ID'],
        ['COLLEGE_ID', 'College ID'],
        ['COLLEGE_NAME', 'College Name'],
      ...
      apiColumns: {},
      userColumns: setFromKeys(['NEXT_FOLLOW_UP', 'NOTES']),
      formulaColumns: {},
      systemColumns: setFromKeys(['CONTACT_ID']),
      linkedColumns: setFromKeys(['COLLEGE_ID', 'COLLEGE_NAME']),
    },
  };
