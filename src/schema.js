  ...
  var SHEETS = {
    COLLEGES: {
      ...
      columns: keyMap(CollegeTools.Config.HEADERS.COLLEGES, [
        ...
        ['ADMISSION_CHANCES', 'Admission Chances'],
        ['ACADEMIC_INDEX_MATCH', 'Academic Index Match'],
        ['MERIT_AID_LIKELIHOOD', 'Merit Aid Likelihood'],
      ...
      formulaColumns: setFromKeys([
        'WEIGHTED_SCORE', 'VALUE_SCORE', 'ADMISSION_CHANCES',
        'ACADEMIC_INDEX_MATCH', 'MERIT_AID_LIKELIHOOD',
      ]),
      linkedColumns: {},
    },
    FINANCIAL_AID: {
