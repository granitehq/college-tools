...
CollegeTools.TaskCatalog = (function() {
  ...
  var ROWS = [
    ...
    ['STR-03', 'Choose applicable planning modules in Task Settings', 'Shared', '', 'Initial setup', 20, 'Module configuration approved'],
    ...
    ['SCH-05', 'Triage scholarship opportunities by value, probability, and effort', 'Shared', '', 'After scholarship research', 60, 'Apply, defer, or skip decisions'],
    ...
    ['TST-04', 'Create and execute SAT/ACT preparation and checkpoint plan', 'Student', 'Tutor', 'Before test', 600, 'Planned checkpoints completed'],
    ...
    ['APP-02', 'Complete Common App profile, contact, and family sections', 'Student', 'Parent/Guardian', 'After account creation', 75, 'Sections validated'],
    ['APP-03', 'Complete Common App education and current-course sections', 'Student', '', 'After transcript collection', 60, 'Education data verified'],
    ['APP-04', 'Complete Common App testing section', 'Student', '', 'After testing decision', 30, 'Testing data consistent'],
    ['APP-05', 'Draft and order Common App activities entries', 'Student', 'Counselor/Professional', 'After activities inventory', 180, 'Ten entries or final set complete'],
    ['APP-06', 'Complete Common App honors section', 'Student', '', 'After honors inventory', 60, 'Final honors entered'],
    ['APP-07', 'Draft Common App additional-information response if justified', 'Student', 'Counselor/Professional', 'Conditional', 90, 'Necessary context stated concisely'],
    ['APP-08', 'Audit and lock reusable Common App data', 'Shared', 'Counselor/Professional', 'Before first submission', 90, 'Base application fact-checked'],
    ...
    ['ESS-06', 'Obtain bounded outside review of the personal statement', 'Counselor/Professional', '', 'After student revision', 60, 'Actionable feedback returned'],
