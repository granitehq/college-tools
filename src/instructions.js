    ...
    var sections = [
      {
        ...
        lines: [
          ...
          '7. Run Task Management > "Setup Task Management" once to create Task Settings, Tasks, and This Week',
          '8. Complete the Task Settings sheet (working deadline, roles, modules), then run',
          '   Task Management > "Generate / Regenerate Task Plan" to build your deadline-aware task list',
          '',
