...
- [architecture-review.md](architecture-review.md) — structural refactorings (schema module, batch I/O, keyed tracker sync…). The Phase 1 removals shrink the surface those refactorings must cover; prefer doing remaining removals before the big refactors.
