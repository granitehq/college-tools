...
- Backlog item 9 partially maps to Phase 1; scoped locks still need a focused implementation detail.
- Backlog item 10 maps to Phase 2.
- Backlog item 11 maps to Phase 3.
- Backlog item 12 maps to Phase 4.
- Backlog item 13 maps to Phases 5 and 7.
